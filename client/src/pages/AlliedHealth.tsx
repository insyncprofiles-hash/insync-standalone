    ...
    <div style={{ background: C.bgPage, minHeight: "100vh", fontFamily: "'Outfit', sans-serif", color: C.textBody }}>
      ...
      <main>
        ...
        <section style={{ padding: "80px 24px 64px", maxWidth: "780px", margin: "0 auto", textAlign: "center" }}>
          ...
          <p style={{ color: C.textBody, fontSize: "clamp(16px, 2vw, 19px)", lineHeight: 1.8, maxWidth: "620px", margin: "0 auto 40px" }}>
        ...
        <section style={{ padding: "0 24px 80px", maxWidth: "720px", margin: "0 auto" }}>
          ...
          <div style={{ marginBottom: "56px" }}>
            <p style={{ fontSize: "clamp(15px, 1.8vw, 17px)", lineHeight: 1.9, marginBottom: "20px", color: C.textBody }}>
            ...
            <p style={{ fontSize: "clamp(15px, 1.8vw, 17px)", lineHeight: 1.9, color: C.textBody }}>
          ...
          <div style={{ marginBottom: "56px" }}>
            ...
            <div style={{ background: C.bgCard, border: `1px solid ${C.border}`, borderRadius: "16px", padding: "28px 28px", marginBottom: "20px" }}>
              <p style={{ fontSize: "15px", lineHeight: 1.9, color: C.textBody, margin: "0 0 12px" }}>The support worker reinforces what the OT introduced.</p>
              <p style={{ fontSize: "15px", lineHeight: 1.9, color: C.textBody, margin: "0 0 12px" }}>The coordinator shares the speech pathologist's approach with a new carer.</p>
              <p style={{ fontSize: "15px", lineHeight: 1.9, color: C.textBody, margin: 0 }}>The family doesn't have to translate between services anymore.</p>
            </div>
            <p style={{ fontSize: "clamp(15px, 1.8vw, 17px)", lineHeight: 1.9, color: C.gold, fontWeight: 700 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(min(260px, 100%), 1fr))", gap: "16px" }}>
            {WHO_CARDS.map((card) => (
              <div key={card.heading} style={{ background: C.bgCard, border: `1px solid ${C.border}`, borderRadius: "16px", padding: "28px 24px", position: "relative", overflow: "hidden" }}>
                ...
                <p style={{ color: C.textBody, fontSize: "14px", lineHeight: 1.75, margin: 0 }}>{card.body}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        <section style={{ padding: "0 24px 80px", maxWidth: "1060px", margin: "0 auto" }} aria-labelledby="profile-holds-heading">
          <div style={{ textAlign: "center", marginBottom: "48px" }}>
            ...
            <p style={{ color: C.textBody, fontSize: "16px", maxWidth: "520px", margin: "14px auto 0", lineHeight: 1.7 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(min(280px, 100%), 1fr))", gap: "14px" }}>
            {PROFILE_HOLDS.map((item) => (
              <div key={item.label} style={{ background: C.bgCard, border: `1px solid ${C.border}`, borderRadius: "14px", padding: "22px 20px", display: "flex", gap: "16px", alignItems: "flex-start" }}>
                ...
                <div>
                  <div style={{ color: C.textHead, fontSize: "15px", fontWeight: 700, marginBottom: "6px" }}>{item.label}</div>
                  <div style={{ color: C.textBody, fontSize: "13px", lineHeight: 1.7 }}>{item.desc}</div>
                </div>
              </div>
            ))}
          </div>
        ...
        <section style={{ padding: "0 24px 100px", maxWidth: "720px", margin: "0 auto", textAlign: "center" }}>
          <div style={{ borderTop: `1px solid ${C.border}`, paddingTop: "64px" }}>
            ...
            <p style={{ color: C.textBody, fontSize: "clamp(15px, 1.8vw, 17px)", lineHeight: 1.9, marginBottom: "16px" }}>
              Because participant engagement doesn't start and end in a session.
            </p>
            <p style={{ color: C.gold, fontSize: "clamp(15px, 1.8vw, 17px)", fontWeight: 700, marginBottom: "48px" }}>
