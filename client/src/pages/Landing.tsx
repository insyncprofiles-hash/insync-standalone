        ...
        >
          ...
          <div style={{ position: "relative", zIndex: 1 }}>
            ...
            <div style={{ display: "flex", gap: "12px", justifyContent: "center", flexWrap: "wrap" }}>
              ...
              <Link href="/view" style={{ background: "transparent", color: C.teal, padding: "13px 32px", borderRadius: "99px", fontSize: "14px", fontWeight: 700, textDecoration: "none", display: "inline-block", border: `1.5px solid ${C.tealDim}` }}>See a Sample Profile</Link>
            </div>
          </div>
        </section>
