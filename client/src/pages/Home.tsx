...
const ALLIED_HEALTH_SERVICES: ServiceItem[] = [
  { id: "ot", icon: "🖐", iconImg: "/manus-storage/ah_01_occupational_therapy_557b3be3.png", label: "OT", selected: false, description: "Functional assessments, home modifications & daily living" },
  { id: "speech", icon: "🗣", iconImg: "/manus-storage/ah_02_speech_pathology_9ae76f89.png", label: "Speech Pathology", selected: false, description: "Communication, AAC, feeding & swallowing" },
  { id: "physio", icon: "💪", iconImg: "/manus-storage/ah_03_physiotherapy_826fdeec.png", label: "Physio", selected: false, description: "Movement, pain management & rehabilitation" },
  { id: "psych", icon: "🧠", iconImg: "/manus-storage/ah_04_psychology_b9d0cf5b.png", label: "Psychology", selected: false, description: "Mental health assessment, therapy & support" },
  { id: "sw-allied", icon: "🤝", iconImg: "/manus-storage/ah_06_social_work_c0caba1e.png", label: "Social Work", selected: false, description: "Psychosocial support, advocacy & coordination" },
  { id: "dietitian", icon: "🥗", iconImg: "/manus-storage/ah_05_dietitian_b67d4b91.png", label: "Dietitian", selected: false, description: "Nutrition, meal planning & feeding support" },
  { id: "music-therapy", icon: "🎵", iconImg: "/manus-storage/ah_07_music_therapy_d32cccd4.png", label: "Music Therapy", selected: false, description: "Therapeutic music for communication & wellbeing" },
  { id: "art-therapy", icon: "🎨", iconImg: "/manus-storage/ah_08_art_therapy_05fe9ff8.png", label: "Art Therapy", selected: false, description: "Creative expression & emotional processing" },
  { id: "exercise-phys", icon: "🏃", iconImg: "/manus-storage/ah_09_exercise_physiology_afc7f5f0.png", label: "Exercise Physiology", selected: false, description: "Therapeutic exercise & physical rehabilitation" },
  { id: "behaviour-support", icon: "💡", iconImg: "/manus-storage/ah_10_behaviour_support_4f04c25d.png", label: "Behaviour Support", selected: false, description: "Positive behaviour strategies & PBS plans" },
  { id: "early-intervention", icon: "🌱", iconImg: "/manus-storage/ah_11_early_intervention_0b5ba8d1.png", label: "Early Intervention", selected: false, description: "Developmental support for children 0–7" },
  { id: "aac-specialist", icon: "📲", iconImg: "/manus-storage/ah_12_aac_specialist_cf7501a9.png", label: "AAC Specialist", selected: false, description: "Augmentative & alternative communication assessment" },
  { id: "telehealth", icon: "💻", iconImg: "/manus-storage/ah_13_telehealth_0945834c.png", label: "Telehealth", selected: false, description: "Remote sessions via video call" },
  { id: "home-visits", icon: "🏠", iconImg: "/manus-storage/ah_14_home_visits_fd34bfac.png", label: "Home Visits", selected: false, description: "In-home assessment & therapy delivery" },
  { id: "school-visits", icon: "🏫", iconImg: "/manus-storage/ah_15_school_visits_00cb5177.png", label: "School Visits", selected: false, description: "Therapy delivered in school settings" },
  { id: "group-therapy", icon: "👥", iconImg: "/manus-storage/ah_16_group_therapy_6e05be46.png", label: "Group Therapy", selected: false, description: "Therapeutic group programs" },
  { id: "sensory-processing", icon: "✨", iconImg: "/manus-storage/ah_17_sensory_processing_340ef085.png", label: "Sensory Processing", selected: false, description: "Sensory integration & regulation strategies" },
  { id: "assistive-tech", icon: "🦾", iconImg: "/manus-storage/ah_18_assistive_technology_63de3085.png", label: "Assistive Tech", selected: false, description: "AT assessment, prescription & training" },
  { id: "capacity-building", icon: "📈", iconImg: "/manus-storage/ah_19_capacity_building_929da1cf.png", label: "Capacity Building", selected: false, description: "Building independence & functional skills" },
  { id: "carer-training", icon: "📚", iconImg: "/manus-storage/ah_20_carer_training_febf198a.png", label: "Carer Training", selected: false, description: "Coaching families & carers in therapeutic strategies" },
];

// ── Coordinator services catalogue ────────────────────────────
const COORDINATOR_SERVICES: ServiceItem[] = [
  { id: "sc", icon: "🗺", iconImg: "/manus-storage/sc_01_support_coordination_bd27e6f1.png", label: "Support Coord.", selected: false, description: "Connecting participants with the right supports" },
  { id: "sc-specialist", icon: "⭐", iconImg: "/manus-storage/sc_02_specialist_support_coordination_7d37fb03.png", label: "Specialist SC", selected: false, description: "Complex needs & crisis coordination" },
  { id: "lac", icon: "🤝", iconImg: "/manus-storage/sc_03_local_area_coordination_9d18b615.png", label: "Local Area Coord.", selected: false, description: "Community connection & plan navigation" },
  { id: "plan-review", icon: "📋", iconImg: "/manus-storage/sc_04_plan_review_a9c8398b.png", label: "Plan Review", selected: false, description: "Preparing for and navigating NDIS plan reviews" },
  { id: "provider-matching", icon: "🔗", iconImg: "/manus-storage/sc_05_provider_matching_8c45189e.png", label: "Provider Matching", selected: false, description: "Finding the right providers for each participant" },
  { id: "capacity-coord", icon: "📈", iconImg: "/manus-storage/sc_06_capacity_building_2db30c2a.png", label: "Capacity Building", selected: false, description: "Building participant independence & skills" },
  { id: "crisis-coord", icon: "🚨", iconImg: "/manus-storage/sc_07_crisis_support_c9a07a28.png", label: "Crisis Support", selected: false, description: "Urgent coordination during crises" },
  { id: "housing-coord", icon: "🏠", iconImg: "/manus-storage/sc_08_housing_sil_b609cca8.png", label: "Housing & SIL", selected: false, description: "Supported Independent Living & housing navigation" },
  { id: "aged-care-coord", icon: "🌿", iconImg: "/manus-storage/sc_09_aged_care_7374e13e.png", label: "Aged Care Nav.", selected: false, description: "Home Care Package & aged care system navigation" },
];
        ...
        {!isClientView && (
          <>
            ...
            >
              ...
              <p style={{ fontFamily: "'Outfit', sans-serif", fontSize: "12px", color: "#78350f", lineHeight: 1.65, margin: "0 0 6px" }}>
                The editor on this device remembers your last entries. To update your profile, simply open the editor on the same device — your data will be there. The link you save is what you share with participants and coordinators.
              </p>
                  ...
                  {DAYS.map(day => (
                    <button
                      ...
                      style={{
                        ...
                        color: profile.availability[day] ? "#ffffff" : A.textMid,
